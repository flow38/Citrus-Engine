package melon.core {
    ...
    public class AMelonObject extends CitrusObject implements IMelonObject {

        public function AMelonObject(name:String, params:Object = null)
        {
            super(name, params);
            //Abstract class implementation
            if (Object(this).constructor === AMelonObject) {
                throw new Error("AMelonObject class is abstract, you must instanciate some of its concrete implementations.");
            }
        ...
        final public function reset(poolObjectParams:Object = null):void
        {
            clean();
